...
export default function Register() {
    ...
    return (
        <GuestLayout>
            <Head title="Daftar Akun SPMB" />

            <div className="mb-6 text-center gsap-fade-down">
                <h2 className="text-2xl font-bold" style={{ color: '#003333' }}>Daftar Akun Baru</h2>
                <p className="text-sm text-slate-500 mt-1">Sistem Penerimaan Murid Baru MI Nurussalam</p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-4 gsap-fade-up">
                ...
                <div>
                    <InputLabel htmlFor="email" value="Alamat Email Aktif" />
