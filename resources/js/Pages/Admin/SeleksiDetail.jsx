                ...
                <div className="lg:col-span-5 space-y-6 gsap-fade-right">
                    ...
                    <div className="rounded-3xl border border-slate-200 bg-white p-6 dark:border-slate-850 dark:bg-slate-950 shadow-sm space-y-6">
                        ...
                        <div className="space-y-4 text-sm font-semibold">
                            ...
                            {/* Status Notifikasi WhatsApp & Email Kelulusan */}
                            {pendaftaran.status === 'lulus' && (
                                <>
                                    <div className="border-t border-slate-100 pt-3 dark:border-slate-850 flex items-center justify-between">
                                        <span className="text-xs text-slate-400 uppercase tracking-widest">Status WA Kelulusan</span>
                                        <WaStatusBadge
                                            status={pendaftaran.status_wa_lulus || 'belum_terkirim'}
                                            sentAt={pendaftaran.wa_lulus_sent_at}
                                        />
                                    </div>
                                    <div className="border-t border-slate-100 pt-3 dark:border-slate-850 flex items-center justify-between">
                                        <span className="text-xs text-slate-400 uppercase tracking-widest">Status Email Kelulusan</span>
                                        <EmailStatusBadge
                                            status={pendaftaran.status_email_lulus || 'belum_terkirim'}
                                            sentAt={pendaftaran.email_lulus_sent_at}
                                        />
                                    </div>
                                </>
                            )}
